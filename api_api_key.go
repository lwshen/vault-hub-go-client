...
// Execute executes the request
//  @return Vault
func (a *APIKeyAPIService) GetVaultByAPIKeyExecute(r ApiGetVaultByAPIKeyRequest) (*Vault, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "APIKeyAPIService.GetVaultByAPIKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Execute executes the request
//  @return Vault
func (a *APIKeyAPIService) GetVaultByNameAPIKeyExecute(r ApiGetVaultByNameAPIKeyRequest) (*Vault, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "APIKeyAPIService.GetVaultByNameAPIKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Execute executes the request
//  @return []VaultLite
func (a *APIKeyAPIService) GetVaultsByAPIKeyExecute(r ApiGetVaultsByAPIKeyRequest) ([]VaultLite, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "APIKeyAPIService.GetVaultsByAPIKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
