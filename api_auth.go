...
func (a *AuthAPIService) ChangePasswordExecute(r ApiChangePasswordRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/auth/password/change"
...
func (r ApiRequestMagicLinkRequest) Execute() (*EmailTokenResponse, *http.Response, error) {
...
func (a *AuthAPIService) RequestMagicLinkExecute(r ApiRequestMagicLinkRequest) (*EmailTokenResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *EmailTokenResponse
	)
...
func (r ApiRequestPasswordResetRequest) Execute() (*EmailTokenResponse, *http.Response, error) {
...
// Execute executes the request
//  @return EmailTokenResponse
func (a *AuthAPIService) RequestPasswordResetExecute(r ApiRequestPasswordResetRequest) (*EmailTokenResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
