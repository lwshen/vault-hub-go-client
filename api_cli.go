...
type ApiUpdateVaultByAPIKeyRequest struct {
	ctx context.Context
	ApiService *CliAPIService
	uniqueId string
...
func (r ApiUpdateVaultByAPIKeyRequest) UpdateVaultRequest(updateVaultRequest UpdateVaultRequest) ApiUpdateVaultByAPIKeyRequest {
	r.updateVaultRequest = &updateVaultRequest
	return r
}

func (r ApiUpdateVaultByAPIKeyRequest) Execute() (*Vault, *http.Response, error) {
	return r.ApiService.UpdateVaultByAPIKeyExecute(r)
}

/*
UpdateVaultByAPIKey Method for UpdateVaultByAPIKey

Update a vault by Unique ID using API key. Supports X-Enable-Client-Encryption header for client-side encryption.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param uniqueId Vault Unique ID
 @return ApiUpdateVaultByAPIKeyRequest
*/
func (a *CliAPIService) UpdateVaultByAPIKey(ctx context.Context, uniqueId string) ApiUpdateVaultByAPIKeyRequest {
	return ApiUpdateVaultByAPIKeyRequest{
		ApiService: a,
		ctx: ctx,
		uniqueId: uniqueId,
...
// Execute executes the request
//  @return Vault
func (a *CliAPIService) UpdateVaultByAPIKeyExecute(r ApiUpdateVaultByAPIKeyRequest) (*Vault, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CliAPIService.UpdateVaultByAPIKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateVaultByNameAPIKeyRequest struct {
	ctx context.Context
	ApiService *CliAPIService
	name string
	updateVaultRequest *UpdateVaultRequest
...
func (r ApiUpdateVaultByNameAPIKeyRequest) UpdateVaultRequest(updateVaultRequest UpdateVaultRequest) ApiUpdateVaultByNameAPIKeyRequest {
	r.updateVaultRequest = &updateVaultRequest
	return r
}

func (r ApiUpdateVaultByNameAPIKeyRequest) Execute() (*Vault, *http.Response, error) {
	return r.ApiService.UpdateVaultByNameAPIKeyExecute(r)
}

/*
UpdateVaultByNameAPIKey Method for UpdateVaultByNameAPIKey

Update a vault by name using API key. Supports X-Enable-Client-Encryption header for client-side encryption.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param name Vault name
 @return ApiUpdateVaultByNameAPIKeyRequest
*/
func (a *CliAPIService) UpdateVaultByNameAPIKey(ctx context.Context, name string) ApiUpdateVaultByNameAPIKeyRequest {
	return ApiUpdateVaultByNameAPIKeyRequest{
		ApiService: a,
		ctx: ctx,
		name: name,
...
// Execute executes the request
//  @return Vault
func (a *CliAPIService) UpdateVaultByNameAPIKeyExecute(r ApiUpdateVaultByNameAPIKeyRequest) (*Vault, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CliAPIService.UpdateVaultByNameAPIKey")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
