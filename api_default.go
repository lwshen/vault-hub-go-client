...
func (r ApiHealthRequest) Execute() (*HealthCheckResponse, *http.Response, error) {
...
func (a *DefaultAPIService) HealthExecute(r ApiHealthRequest) (*HealthCheckResponse, *http.Response, error) {
	var (
