...
func (r ApiGetCurrentUserRequest) Execute() (*GetUserResponse, *http.Response, error) {
...
func (a *UserAPIService) GetCurrentUserExecute(r ApiGetCurrentUserRequest) (*GetUserResponse, *http.Response, error) {
	var (
