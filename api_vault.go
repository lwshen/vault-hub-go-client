...
func (r ApiGetVaultsRequest) Execute() ([]VaultLite, *http.Response, error) {
...
// Execute executes the request
//  @return []VaultLite
func (a *VaultAPIService) GetVaultsExecute(r ApiGetVaultsRequest) ([]VaultLite, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
