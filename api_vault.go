...
type ApiGetVaultFilterOptionsRequest struct {
	ctx context.Context
	ApiService *VaultAPIService
}

func (r ApiGetVaultFilterOptionsRequest) Execute() (*VaultFilterOptionsResponse, *http.Response, error) {
	return r.ApiService.GetVaultFilterOptionsExecute(r)
}

/*
GetVaultFilterOptions Method for GetVaultFilterOptions

Get minimal vault list for filter dropdowns (uniqueId and name only)

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetVaultFilterOptionsRequest
*/
func (a *VaultAPIService) GetVaultFilterOptions(ctx context.Context) ApiGetVaultFilterOptionsRequest {
	return ApiGetVaultFilterOptionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return VaultFilterOptionsResponse
func (a *VaultAPIService) GetVaultFilterOptionsExecute(r ApiGetVaultFilterOptionsRequest) (*VaultFilterOptionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *VaultFilterOptionsResponse
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VaultAPIService.GetVaultFilterOptions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/vaults/filter-options"
