...
// GetEmailEnabled returns the EmailEnabled field value
...
// GetEmailEnabledOk returns a tuple with the EmailEnabled field value
// and a boolean to check if the value has been set.
...
// SetEmailEnabled sets field value
func (o *ConfigResponse) SetEmailEnabled(v bool) {
	o.EmailEnabled = v
}

// GetDemoEnabled returns the DemoEnabled field value
func (o *ConfigResponse) GetDemoEnabled() bool {
	...
	return o.DemoEnabled
}

// GetDemoEnabledOk returns a tuple with the DemoEnabled field value
// and a boolean to check if the value has been set.
func (o *ConfigResponse) GetDemoEnabledOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
	return &o.DemoEnabled, true
}

// SetDemoEnabled sets field value
...
func (o ConfigResponse) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["demoEnabled"] = o.DemoEnabled
